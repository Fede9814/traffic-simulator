...
class Entity(pg.sprite.Sprite):
    ...
    def __init__(self, pos, waypoints):
        ...
        #sai cos'e un waypoint vero? bon dai te lo dico io, e approssimabile ad un "checkpoint" dei videogiochi.
    ...
    def update(self):
        ...
        # se la distanza e minore (quindi sei vicino) del raggio dal centro di massa
        ...
        # la posizione si aggiorna in base alla velocita
        self.pos += self.vel
