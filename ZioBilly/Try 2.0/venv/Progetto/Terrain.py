...
class Semaforo(pg.sprite.Sprite):
    def __init__(self, image_file, location):
        ...
        self.verde = pg.image.load('C:/Users/PC/Desktop/traffic-simulator/ZioBilly/Try 2.0/venv/img/luce_verde.png')
        self.giallo = pg.image.load('C:/Users/PC/Desktop/traffic-simulator/ZioBilly/Try 2.0/venv/img/luce_giallo.png')
        self.rosso = pg.image.load('C:/Users/PC/Desktop/traffic-simulator/ZioBilly/Try 2.0/venv/img/luce_rosso.png')
