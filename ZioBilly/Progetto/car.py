...
class Car(pygame.sprite.Sprite):
	...
	def __init__(self):
		...
		if(self.colore == 1):
			self.image = pygame.image.load('S:/TrafficSim/img/car_red.png')
		elif(self.colore == 2):
			self.image = pygame.image.load('S:/TrafficSim/img/car_blue.png')
		elif(self.colore == 3):
			self.image = pygame.image.load('S:/TrafficSim/img/car_green.png')
		elif(self.colore == 4):
			self.image = pygame.image.load('S:/TrafficSim/img/car_yellow.png')
		elif(self.colore == 5):
			self.image = pygame.image.load('S:/TrafficSim/img/truck.png')
